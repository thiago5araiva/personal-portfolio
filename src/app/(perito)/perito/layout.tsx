...
export const metadata: Metadata = {
	...
	openGraph: {
		title: 'Perito Judicial em Tecnologia — Perícia Digital Forense',
		description: 'Análise técnica com fundamento científico, rigor metodológico e credibilidade probatória para decisões judiciais seguras.',
	...
	twitter: {
		...
		description: 'Análise técnica com fundamento científico e credibilidade probatória para decisões judiciais seguras.',
		images: ['/og-image.jpg'],
	},
}
...
export default function PeritoLayout({ children }: Props) {
	return (
		<main id="perito-layout">
			<Script src="https://www.googletagmanager.com/gtag/js?id=AW-16550274592" strategy="afterInteractive" />
			...
			<div className="w-[100vw] relative left-[calc(-50vw+50%)] overflow-x-hidden">{children}</div>
		</main>
	)
}
