...
export const COMPANIES_LOGO = [
    { alt: 'Accenture', image: accenture },
    { alt: 'BairesDev', image: baires },
    { alt: 'Cheesecake', image: cheesecake },
    { alt: 'Hospital Albert Einstein', image: einstein },
    { alt: 'Labsit', image: labsit },
    { alt: 'Magalu', image: magalu },
    { alt: 'Midway', image: midway },
    { alt: 'Pinterest', image: pinterest },
    { alt: 'Porto Seguro', image: porto },
    { alt: 'Squarespace', image: squarespace },
]
